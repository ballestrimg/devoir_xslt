...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="home">
        <xsl:value-of select="concat('negres_afrique_sus_equatoriale_home','.html')"/>
    </xsl:variable>
    <!-- variable : chap1 -->
    <xsl:variable name="chap1">
        <xsl:value-of select="concat('negres_afrique_sus_equatoriale_chap1','.html')"/>
    </xsl:variable>
    <!-- variable : chap2 -->
    <xsl:variable name="chap2">
        <xsl:value-of select="concat('negres_afrique_sus_equatoriale_chap2','.html')"/>
    </xsl:variable>
    <!-- variable : chap3 -->
    <xsl:variable name="chap3">
        <xsl:value-of select="concat('negres_afrique_sus_equatoriale_chap3','.html')"/>
    </xsl:variable>
    <!-- variable : index -->
    <xsl:variable name="index">
        <xsl:value-of select="concat('negres_afrique_sus_equatoriale_index','.html')"/>
    </xsl:variable>
